...
<Head>
  <title>{'About - Material React Table V4'}</title>
  <meta
    name="description"
    content="About Material React Table. A fully-featured table component library for React based on TanStack Table V9 and Material Design."
  />
</Head>

## About Material React Table

Material React Table is a fully featured Material UI V9 implementation of TanStack React Table V9, written from the ground up in TypeScript.

### About This Fork

This site documents Material React Table V4, a community fork of [KevinVandy/material-react-table](https://github.com/KevinVandy/material-react-table) published on npm as `@lminii/material-react-table` and maintained by [Tyler Lee](https://github.com/lminii). The fork exists to keep MRT current with Material UI V9 and TanStack Table V9. The API is unchanged from V3 apart from what those two upgrades require; see the [V4 migration guide](/docs/getting-started/migrating-to-v4). Upstream V3 continues at [material-react-table.com](https://www.material-react-table.com), and Material React Table itself was written by Kevin Van Cott.

### What is Material React Table?

Material React Table (MRT) is a fully-featured data grid/table component library for React built on [TanStack Table V9's](https://react-table.tanstack.com/) powerful API. MRT is meant to work best in projects already using [Material UI](https://material-ui.com/) components, but it is not necessarily required. However, be aware that [Material UI](https://material-ui.com/) and [Emotion](https://emotion.sh/) are required as peer dependencies for MRT to work.
...
Material React Table is licensed under the [MIT License](https://github.com/lminii/material-react-table/blob/v4/LICENSE) and is free to use in both personal and commercial projects.

### Features

✅ < 65kb gzipped - [Bundlephobia](https://bundlephobia.com/package/@lminii/material-react-table)
...
If you would like to contribute code to the project, please read the [Contributing Guide](https://github.com/lminii/material-react-table/blob/v4/CONTRIBUTING.md) to learn how to get started.

#### Support the Project

If you enjoy this library, please consider supporting the project by leaving a ⭐️ on the [fork's GitHub repository](https://github.com/lminii/material-react-table) and on the [upstream repository](https://github.com/KevinVandy/material-react-table).

Nothing financial is required at all to support this library. The greatest help of all, actually, is to get involved in the project and community. Submitting [issues](https://github.com/lminii/material-react-table/issues), [pull requests](https://github.com/lminii/material-react-table/pulls), and helping others in the [Discord Server](https://discord.gg/5wqyRx6fnm) are all great ways to help out.
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '<p><b>Yes</b>, <a href="/about#faqs">as stated above</a>, this library uses the <b>MIT</b> License and is free to use for either personal or enterprise projects.</p>',
        },
      },
      {
        '@type': 'Question',
