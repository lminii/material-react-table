...
<Head>
  <title>{'Usage - Material React Table V4 Docs'}</title>
  <meta
    name="description"
...
To start using MaterialReactTable, you first need to [install](/docs/getting-started/install) `@lminii/material-react-table` and the necessary Material UI V9 dependencies.
